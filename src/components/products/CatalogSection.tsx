...
const categoryDiagramConfigs: Record<string, CategoryDiagramConfig> = {
  ...
  "polidoras": {
    ...
    totalLength: "57,0 mm",
    grainColors: [
      { name: "Extra Grosso", color: "#5C4033", label: "Extra Grosso (Marrom)" },
      { name: "Grosso", color: "#9E9E9E", label: "Grosso (Cinza)" },
      { name: "Médio-Grosso", color: "#FFFFFF", label: "Médio-Grosso (Branco)" },
      { name: "Médio", color: "#4CAF50", label: "Médio (Verde)" },
      { name: "Fino", color: "#2196F3", label: "Fino (Azul)" },
      { name: "Extra Fino", color: "#FFEB3B", label: "Extra Fino (Amarelo)" },
      { name: "Ultra Fino", color: "#C39BD3", label: "Ultra Fino (Lilás)" },
    ],
    modelPrefix: "70",
  },
  "escovas-limpeza": {
