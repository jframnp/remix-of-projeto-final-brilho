      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-10 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-16">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-[#EEEEEE] font-montserrat font-bold text-base sm:text-lg mb-4 sm:mb-8 tracking-wider">
              MENU
            </h3>
          ...
          <div className="flex flex-col items-center text-center order-first sm:order-none">
            ...
            <div className="flex flex-col items-center mb-4 sm:mb-8">
              <img 
                ...
                className="h-16 sm:h-20 w-auto mb-3 sm:mb-4 hover:scale-110 transition-transform duration-300"
              />
            </div>

            {/* CNPJ / IE */}
            <div className="text-[#EEEEEE]/80 font-inter text-xs sm:text-sm mb-4 sm:mb-6 space-y-1">
            ...
            {/* Company Description */}
            <p className="text-[#EEEEEE]/70 font-inter text-xs sm:text-sm leading-relaxed max-w-md hidden sm:block">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="text-[#EEEEEE]/90 font-inter text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="text-[#EEEEEE]/90 font-inter text-sm sm:text-base">
              <p>E-mail:</p>
              <a 
                href="mailto:metalurgicabrilho@gmail.com"
                className="hover:text-[#EEEEEE] transition-colors hover:underline break-all"
              >
        ...
        {/* Social Icons */}
        <div className="flex justify-center gap-3 sm:gap-5 mt-10 sm:mt-16 mb-6 sm:mb-8">
          <a
            href="https://facebook.com"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 sm:w-10 sm:h-10 bg-[#1877F2] rounded-full flex items-center justify-center hover:opacity-80 hover:scale-110 transition-all duration-300"
            aria-label="Facebook"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-tr from-[#FCAF45] via-[#E1306C] to-[#833AB4] rounded-full flex items-center justify-center hover:opacity-80 hover:scale-110 transition-all duration-300"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 sm:w-10 sm:h-10 bg-[#FF0000] rounded-full flex items-center justify-center hover:opacity-80 hover:scale-110 transition-all duration-300"
            aria-label="YouTube"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 sm:w-10 sm:h-10 bg-[#0A66C2] rounded-full flex items-center justify-center hover:opacity-80 hover:scale-110 transition-all duration-300"
            aria-label="LinkedIn"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center border-t border-white/10 pt-6 sm:pt-8">
          <p className="text-[#EEEEEE]/60 font-inter text-xs sm:text-sm">
