      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-12">
          <div className="flex items-center gap-3">
            ...
            <span className="text-brilho-text-light font-montserrat font-bold text-xl tracking-wide">
              METALÚRGICA BRILHO
            </span>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-brilho-text-light/10 rounded-full flex items-center justify-center hover:bg-brilho-red-vivid transition-colors"
          >
            <svg
              className="w-5 h-5 text-brilho-text-light"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
